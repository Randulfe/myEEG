...
s.bind((socket.gethostname(), 5200))
s.listen(BUFFER_LENGTH)
...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            """4 CREATE DETA MESSAGE"""

            time.sleep(1)
                

            data = {"Frequencies":{"ALPHA":band_powers[Band.Alpha], "BETA":band_powers[Band.Beta], "DELTA":band_powers[Band.Delta], "THETA":band_powers[Band.Theta]},"Frequency Protocols":{"A/D":alpha_metric,"B/T":beta_metric,"T/A":theta_metric}}
